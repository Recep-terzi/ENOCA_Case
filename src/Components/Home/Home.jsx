                ...
                {health && (
                  <>
                    ...
                    <div className="health-info col-md-6">
                      ...
                      <div className="health-time">{health[0].publishedAt}</div>
                    </div>
                  </>
                )}
              </div>
                ...
                {health && (
                  <>
                    ...
                    <div className="health-info col-md-6">
                      ...
                      <div className="health-time">{health[1].publishedAt}</div>
                    </div>
                  </>
                )}
              </div>
                ...
                {health && (
                  <>
                    ...
                    <div className="health-info col-md-6">
                      ...
                      <div className="health-time">{health[2].publishedAt}</div>
                    </div>
                  </>
                )}
              </div>
                  ...
                  <div className="info">
                    {data && (
                      <>
                        ...
                        <div className="info-time">{data[10].publishedAt}</div>
                      </>
                    )}
                  </div>
                </div>
                  ...
                  <div className="info">
                    {data && (
                      <>
                        ...
                        <div className="info-time">{data[11].publishedAt}</div>
                      </>
                    )}
                  </div>
                </div>
